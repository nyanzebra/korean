## 네요, 군요/구나/구먼/구만 (expressing surprise/realization) #card
?begin
### Usage
Both endings express surprise or new realization ("Oh...", "I see...", "wow"), but with different nuances:
#### 네요
If you want to express surprise in Korean, you can use -네요. This can give the nuance of "wow" or something like that.
#### 군요 / 구나
-군요 / -구나 is another way of expressing surprise/realization ("Oh.."/"I see..."), but it's generally used in more formal situations (although you can use it informally if you wanted to). 구나 is only used in casual speech.
#### 구먼
An older version of 군. Also only casual, but can add (요).
#### 구만
An incorrect version of 구먼, but for some reason people use it anyway. Can be playful and almost sarcastic, but not used with (요).
### Form
#### 네요
| -   | 과거   | 현재   |
| --- | ---- | ---- |
