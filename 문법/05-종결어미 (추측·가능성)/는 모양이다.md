...
### Restrictions
Only can be used for things that are observable.
### Examples
* 비가 올 모양이다.
...
### Notes
* 것 같다 is more general and maybe more inferred/softer
* 모양이다 requires some sort of evidence, it is not based on feeling but some fact

https://www.topikguide.com/a-v-%EC%9C%BC%E3%84%B4-%EB%8A%94-%EB%AA%A8%EC%96%91%EC%9D%B4%EB%8B%A4-korean-grammar/
<!--SR:!2027-05-24,316,230-->
?end
