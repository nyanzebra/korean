...
- ‘신뢰’라는 것은 어렵게 쌓이는 것이지만 쉽게 파괴될 수 있어요. (The thing called or said to be) trust is something that is difficult to build up but easily destroyed.
...
* 나는 철수가 영희를 좋아한다는 걸 알아
	* I know the fact that he likes her
### Notes
This below note needs to be re-confirmed... it seems from AI at least that both are fine; where one indicates a fact and the other has an air of needing confirmation to it.
(ㄴ/는)다는 것 vs (ㄴ/는)것
