...
Adding 다가 to the beginning of this pattern is used to tell how something happened.
### Form
게 됐어요 is attached to end of verb
### Restrictions
### Examples
1.  *A* 승기 씨, 저희 야구 동호회에 처음 오셨지요? 자기소개 좀 해 주세요.
    *B* 안녕하세요? 이승기입니다. 좋아하는 운동도 하고 친구도 사귀고 싶어서 나오게 됐어요.
2.   *A* 어떻게 해서 저희 동호회에 가입하게 되셨어요?
    *B* 인터넷에서 동호회 광고를 찾다가 관심이 생겨서 가입하게 됐습니다. 앞으로 열심히 활동하겠습니다.
3.   *A* 어떻게 한국에 오게 됐어요?
    *B* 한국 친구랑 얘기하다가 한국어를 더 배우고 싶어져서 공부하러 오게 됐어요
...
When using '게 되다' pattern after verbs involving the senses (see, hear, touch, etc..), '아/어서' is usually replaced by '고' in the first clause, since the two clauses represent sequential rather than directly causal actions.
